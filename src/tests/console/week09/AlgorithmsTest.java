package tests.console.week09;

import algorithms.iterative.Sort;

import java.util.Arrays;
import static algorithms.iterative.Search.binarySearch;
import static algorithms.iterative.Sort.bubbleSort;
import static algorithms.iterative.Search.contains;
import static algorithms.iterative.Search.indexOf;
import static algorithms.iterative.Sort.insertionSort;
import static algorithms.iterative.Sort.selectionSort;
import static algorithms.recursive.Sort.mergeSort;
import static algorithms.recursive.Sort.quickSort;
...
public class AlgorithmsTest {
    ...
    public static void checkRecursiveBinarySearch(int[] array){
        ...
        int loc01 = algorithms.recursive.Search.binarySearch(array, 2);
        int loc02 = algorithms.recursive.Search.binarySearch(array, 7);
        int loc03 = algorithms.recursive.Search.binarySearch(array, 9);
